...
export BB_ENV_EXTRAWHITE="$BB_ENV_EXTRAWHITE CORRETTO_VER"
...
RDEPENDS_${PN} += "${@ 'corretto-8-bin' if d.getVar('CORRETTO_VER') else 'corretto-11-bin'}"
RDEPENDS_${PN} += "ca-certificates python3 python3-json python3-numbers"
